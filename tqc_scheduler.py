...
from customenvs.scheduler import SchedulerEnv
import os

import argparse


env = SchedulerEnv(completion_rates=[0.05, 0.1, 0.5], rewards=[10.0, 3.0, 2.0])
policy_kwargs = dict(n_critics=2, n_quantiles=25)
model = TQC("MlpPolicy", env, top_quantiles_to_drop_per_net=2, verbose=1, learning_starts=5_000, policy_kwargs=policy_kwargs)
